...
public class ItemsTagsService implements ItemsTagsServiceImpl {
    ...
    public Integer processMetaObjectByTypes(JsonObject origMetasArraysByType, JsonObject actionItemsArraysByType, JsonArray typesArr
        ...
        int rt = 0;
        System.out.println("[********] " + dateFormat.format(new Date()) + "  " + dateFormat.format(new Date()) + " ItemsTagsService.processMetaObjectByTypes start");
        ...
        System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes metaDic start");
        ...
        System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes metaDic end");

        System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes meta for start");
        if (typesArr != null && origMetasArraysByType != null && actionItemsArraysByType != null) {
            ...
            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes setEmptyMetas start");
            JsonObject origMetasArraysByType2 = setEmptyMetas(origMetasArraysByType, this.getOrigTypes());
            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes setEmptyMetas end");

            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes meta for start");
            for (String atype : this.getOrigTypes()) {
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes meta for : atype = " + atype + " start");
                ...
                if (changeMetaArr != null) {
                	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes meta for : atype = " + atype + " - changeMetaArr not null");
                    ...
                    if (destArr != null) {
                        ...
                        if (!atype.toUpperCase().contains("AWARD")) {
                            ...
                            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes meta for : atype = " + atype + " insItemsTagsMetas before : mtype,meta = " + atype+","+destMeta);
                            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes meta for : atype = " + atype + " insItemsTagsMetas before : reqMeta = " + reqMeta);
                            rt = this.insItemsTagsMetas(reqMeta);
                            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes meta for : atype = " + atype + " insItemsTagsMetas after : rt = " + rt);
                        } else {
                            ...
                            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes meta for : atype = " + atype + " insItemsTagsMetas before : mtype,meta = " + atype+","+destMeta);
                            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes meta for : atype = " + atype + " insItemsTagsMetas before : reqM = " + reqM);
                	...
                	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes meta for : atype = " + atype + " - changeMetaArr null");
                    if (origMetaArr != null) {
                        ...
                        if (!atype.toUpperCase().contains("AWARD")) {
                            ...
                            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes 메타 반복문 : atype = " + atype + " insItemsTagsMetas before : mtype,meta = " + atype+","+destMeta);
                            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes 메타 반복문 : atype = " + atype + " insItemsTagsMetas before : reqMeta = " + reqMeta);
                            rt = this.insItemsTagsMetas(reqMeta);
                            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes 메타 반복문 : atype = " + atype + " insItemsTagsMetas after : rt = " + rt);
                        } else {
                            // AWARD�쓽 寃쎌슦 items_metas�뿉 湲곗〈硫뷀�瑜� �쑀吏��븳�떎 18.05.15
                            ItemsMetas reqM = new ItemsMetas();
                            reqM.setIdx(itemid);
                            ...
                            reqM.setRegid(serverid);
                            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes 메타 반복문 : atype = " + atype + " insItemsTagsMetas before : mtype,meta = " + atype+","+destMeta);
                            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes 메타 반복문 : atype = " + atype + " insItemsTagsMetas before : reqM = " + reqM);
                            rt = itemsMetasMapper.insItemsMetas(reqM);
                            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes 메타 반복문 : atype = " + atype + " insItemsTagsMetas after : rt = " + rt);
            	...
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes meta for : atype = " + atype + " end");
            }
            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes meta for end");
        }
        System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.processMetaObjectByTypes meta for end");
        return rt;
    }
    ...
    public int changeMetasArraysByTypeFromInputItems (int itemid, String items, String duration, String sendnow) {
		System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems 시작");
		System.out.println(" - itemid = " + itemid);
        ...
        try {
            ...
            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - input asfasfd = " + items);
            JsonObject actionItemsArraysByType = this.getArraysByTypeFromInputItems(items);
            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - output asfasfd = " + actionItemsArraysByType.toString());
            System.out.println("#actionItemsArraysByType:"+actionItemsArraysByType.toString());
            ...
            if(lastTag != null && !"S".equals(lastTag.getStat())) {
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - no gaseungin metas");
            	
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - getItemsMetasByItemIdx bf");
            	JsonObject origMetasArraysByType = this.getItemsMetasByItemIdx(itemid, false);
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - getItemsMetasByItemIdx af : origMetasArraysByType = " + origMetasArraysByType.toString());

                // AWARD 泥섎━瑜� �쐞�빐 ITEMS_METAS�뿉�꽌 �씫�뼱�꽌 援ъ“泥댁뿉 異붽�
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - getAwardObject bf(call) : AWARD ~~~");
                origMetasArraysByType = this.getAwardObject(itemid, origMetasArraysByType);
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - getAwardObject af : origMetasArraysByType = " + origMetasArraysByType.toString());

                System.out.println("#origMetasArraysByType:"+origMetasArraysByType.toString());

                /* action_item�씠 �엳�뒗 寃쎌슦 ���엯蹂� meta �닔�젙 */
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - processMetaObjectByTypes before(호출) action_item이 있는 경우 타입별 meta 수정");
                int rtm = this.processMetaObjectByTypes(origMetasArraysByType, actionItemsArraysByType, typesArr, itemid, curTagIdx);
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - processMetaObjectByTypes after : rtm = " + rtm);
            	System.out.println(" - origMetasArraysByType " + origMetasArraysByType.toString());
            	System.out.println(" - actionItemsArraysByType " + actionItemsArraysByType.toString());
                ...
                /* �빐�떦 items_tags_keys 瑜� �듅�씤�쑝濡� �뾽�뜲�씠�듃 �븳�떎 */
                ItemsTags reqConfirm = new ItemsTags();
                reqConfirm.setIdx(itemid);
                reqConfirm.setTagidx(curTagIdx);
                reqConfirm.setStat("S");
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - uptItemsTagsKeysStat before");
                int rts = this.uptItemsTagsKeysStat(reqConfirm);
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - uptItemsTagsKeysStat after : rts = " + rts);

                /* �빐�떦 items_stat 瑜� �듅�씤�쑝濡� �뾽�뜲�씠�듃 �븳�떎 */
                reqIt = new Items();
                reqIt.setIdx(itemid);
                reqIt.setStat("ST");
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - itemsMapper.insItemsStat before");
                int rti = itemsMapper.insItemsStat(reqIt);
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - itemsMapper.insItemsStat after : rti = " + rti);

                rt = 1;

                tagcnt = curTagIdx + 1;
            } else {
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems -   added 2018.04.11");
                /* �씠�쟾 �긽�깭 肄붾뱶 �솗�씤�븯�뿬 �듅�씤�셿猷�(ST)媛� �븘�땶 寃쎌슦 �듅�씤�셿猷뚮줈 泥섎━  added 2018.04.11 */
                String oldItemsStat = itemsMapper.getItemsStatByIdx(itemid);
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - oldItemsStat " + oldItemsStat);
                if (!"ST".equals(oldItemsStat)) {
                    ...
                    /* 湲곗듅�씤�맂 硫뷀�媛� �엳�쓣 寃쎌슦 tagidx瑜� �떊洹� �깮�꽦�븳�떎..  18.05.16 */
                    curTagIdx =  this.getCurrTagsIdxForInsert(itemid);
                	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - curTagIdx " + curTagIdx);
                    ...
                    /* �빐�떦 items�쓽 tagcnt瑜� 理쒖쥌 tagidx濡� �닔�젙�븳�떎 */
                    // �븘�옒 留덉�留� �씪�씤 李몄“
                    /* �빐�떦 items_stat 瑜� �듅�씤�쑝濡� �뾽�뜲�씠�듃 �븳�떎 */
                    reqIt = new Items();
                    reqIt.setIdx(itemid);
                ...
                /* 湲곗듅�씤�맂 硫뷀�媛� �엳�쓣 寃쎌슦, items_tags_metas 留� �닔�젙�븳�떎 */
                ...
                /* action_item�씠 �엳�뒗 寃쎌슦 ���엯蹂� meta �닔�젙 */
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - processMetaObjectByTypes before");
                int rtm = this.processMetaObjectByTypes(origMetasArraysByType, actionItemsArraysByType, typesArr, itemid, curTagIdx);
            	System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - processMetaObjectByTypes after : rtm = " + rtm);
            	System.out.println(" - origMetasArraysByType " + origMetasArraysByType.toString());
            	System.out.println(" - actionItemsArraysByType " + actionItemsArraysByType.toString());
            ...
            System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction befare");
            if (rt > 0) {
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction rt > 0");
                /* �빐�떦 items_tags_keys 瑜� �듅�씤�쑝濡� �뾽�뜲�씠�듃 �븳�떎  */
                ItemsTags reqConfirm = new ItemsTags();
                reqConfirm.setIdx(itemid);
                reqConfirm.setTagidx(curTagIdx);
                reqConfirm.setStat("S");
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction rt > 0 - uptItemsTagsKeysStat before");
                System.out.println(" - itemid = " + itemid);
                System.out.println(" - curTagIdx = " + curTagIdx);
                System.out.println(" - stat = S");
                int rts = this.uptItemsTagsKeysStat(reqConfirm);
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction rt > 0 - uptItemsTagsKeysStat after : rts = " + rts);
                System.out.println(" - itemid = " + itemid);
                System.out.println(" - curTagIdx = " + curTagIdx);
                System.out.println(" - stat = S");
                ...
                reqIt = new Items();
                reqIt.setIdx(itemid);
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction rt > 0 - getItemsByIdx before");
                Items itemInfo = itemsService.getItemsByIdx(reqIt);
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction rt > 0 - getItemsByIdx after : itemInfo = " + itemInfo.toString());
                String movietitle = "";
                movietitle = (itemInfo != null && itemInfo.getTitle() != null) ? itemInfo.getTitle().trim() : "";
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction rt > 0 - insItemsHist before");
                int rthist = itemsService.insItemsHist(itemid, "meta", "S", movietitle, "CONFIRM_META", itemid);
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction rt > 0 - insItemsHist after : rthist = " + rthist);

                // TagCnt 1 利앷� // �씪�떒 �뾽�뜲�씠�듃 援щЦ�쑝濡� �빐寃�
                //int oldTagCnt = itemInfo.getTagcnt();
                //int newTagCnt = oldTagCnt + 1;
                //reqIt.setTagcnt(newTagCnt);

                /* �빐�떦 items �젙蹂대�� 蹂�寃쏀븳�떎.  tagcnt++,  duration */
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction rt > 0 - target items change");
                if (!"".equals(duration)) reqIt.setDuration(duration);
                reqIt.setTagcnt(tagcnt);
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction rt > 0 - uptItemsTagcnt before");
                int rtu = itemsService.uptItemsTagcnt(reqIt);
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction rt > 0 - uptItemsTagcnt after : rtu = " + rtu);
                logger.info("#MLOG:uptItemsTagcnt for itemIdx:"+itemid);

                /* �빐�떦 items�쓽 sched_target_content �썝臾몄쓣 紐⑤몢 �궘�젣�븳�떎  18.05.16 */
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction rt > 0 - deleteSchedTargetContentOrigin before");
                int rtd = schedTriggerService.deleteSchedTargetContentOrigin(itemid);
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction rt > 0 - deleteSchedTargetContentOrigin after : rtd = " + rtd);
            }

            if ("Y".equals(sendnow.toUpperCase())) {
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction sendnow=Y");
                Map<String,Object> reqCcube = new HashMap();
                reqCcube.put("idx", itemid);
                reqCcube.put("regid", serverid);
                System.out.println(" - itemid = " + itemid);
                System.out.println(" - serverid = " + serverid);
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction rt > 0 - insCcubeOutput before");
                int rtc = ccubeService.insCcubeOutput(reqCcube);
                System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems - saveAction rt > 0 - insCcubeOutput after : rtc = " + rtc);
            }
        ...
        System.out.println("[********] " + dateFormat.format(new Date()) + "  ItemsTagsService.changeMetasArraysByTypeFromInputItems end : rt = " + rt);
        return rt;
    }

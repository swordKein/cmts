    ...
    public void writeMetaDicKeywordsByTypes() throws Exception {
        ...
        for(String type : types) {
            ...
            */
            ...
            String fileNameContent = "META_DIC_TYPE_"+type+"_190827.csv";
            int rtFileC = FileUtils.writeYyyymmddFileFromStr(resultStr, UPLOAD_DIR, fileNameContent, "euc-kr");
        }
                        ...
                        if (cntAwardIdx < 1) {
                            ...
                            if (result != null) {
                                if (result.get("metas") != null) {
                                    ...
                                    System.out.println("##metas.get(award) : "+metas.get("award"));

                                    if (metas != null && metas.get("award") != null) {
                                        JsonArray destMetaArr = (JsonArray) metas.get("award");
                                        String destMeta = "";
                                        if (destMetaArr != null && destMetaArr.size() > 0) destMeta = destMetaArr.toString();

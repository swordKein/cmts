...
public class HadoopClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String hdfsPath = "hdfs://" + "210.122.36.199:8020";


        UserGroupInformation ugi = UserGroupInformation.createProxyUser("phr", UserGroupInformation.getLoginUser());

        Configuration conf = new Configuration();
        conf.set("fs.default.name", hdfsPath);
        conf.set("hadoop.job.ugi", "phr");

        client.mkdir("/tmp/freq/test1", conf);
        client.addFile("E:\\tmp\\hadoop-wodus77\\in\\1.txt", "/tmp/freq/test1/1.txt", conf);

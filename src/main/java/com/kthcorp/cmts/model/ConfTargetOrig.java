...
@Alias("ConfTargetOrig")
public class ConfTargetOrig extends Paging {
    @Override
    ...
    private List<ConfPresetOrig> presetList;
    ...
    public List<ConfPresetOrig> getPresetList() {
        return presetList;
    }

    public void setPresetList(List<ConfPresetOrig> presetList) {

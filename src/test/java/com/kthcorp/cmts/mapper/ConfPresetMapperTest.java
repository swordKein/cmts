...
public class ConfPresetMapperTest {
    @Autowired
    ...
    public void test_insConf_preset_for_naver_movie() {
        ...
        for(ConfPreset cp : psList) {
            cp.setPriority(20);
            cp.setRegid("ghkdwo77");

            int rt = confPresetMapper.insertConfPreset(cp);
    ...
    @Test
    @Rollback(false)
    public void test_insConf_preset_for_naver_movie2__1001_1004() {
